// Zips the packaged Windows build into dist/Grow-Co-win64-v<version>.zip, ready to attach to a release.
var cp = require('child_process'), path = require('path'), fs = require('fs'); var v = require('../package.json').version;
var dir = path.join(__dirname, '..', 'dist', 'Grow Co-win32-x64'), zip = path.join(__dirname, '..', 'dist', 'Grow-Co-win64-v' + v + '.zip');
