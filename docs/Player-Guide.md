...
- [Controls](#controls)
- [Growing and quality](#growing-and-quality)
- [Selling](#selling)
...
- The **rope line** across the way in is a gate. Customers stop at it. Once the guard has checked an ID he unhooks it, lets them through and hooks it back behind them. People leaving walk round the far end of it, behind the guard's podium, so they never cut through the gate or the line. While the guard is sent home the rope stays unhooked. You can always walk through it. E on it leaves it unhooked, or changes the colour, length, style and posts, turns it, puts up another beside it or takes it down. Every rope you put up works the same way. F2 moves it. More are under Gear, Machines, on the office PC.
...
- Time away from the game turns the calendar one day at most, so the bills fall once, not once for every day you were gone.
...
- Serve on a bad ID and it's on you (heat +12, rep -4), with a 30% chance of a police fine on top. That goes for one the guard waved through too, if nobody caught it. Refuse a bad one and you gain rep. Refuse a perfectly good one and you lose it.
...
- **Doors** can be shut and locked from the control box, or at the door itself with the keyring. Your crew and the guard have keys. A robber forces a locked door and breaks the lock.
...
- **Green Leaf**: the rival. Flyer them for rep. At 150 rep you can buy them out for $180,000. After that it's your branch: carry bags, joints or cookies to the blue beacon out front, and each morning it pays $9 for every unit you dropped off (up to 60 a day), plus $2 for every point of rep. A manager runs it for $120 a day on the bills.
...
- Your crew and the guard carry their own keys. They let themselves through and lock up behind them. A robber has to force a locked door, which costs him time.
